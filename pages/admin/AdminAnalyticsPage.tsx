    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted text-sm">Вэбсайтын уншигчид, хандалтын тоо, нийтлэлийн үр өгөөжийг хянах нэгдсэн хянах самбар</p>
        </div>
        ...
        <div className="relative">
          <select
            ...
            className="appearance-none pl-4 pr-10 py-2.5 bg-[#131B2E]/60 border border-border rounded-xl text-text-main text-xs font-semibold outline-none focus:border-brand-purple/50 transition-colors cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* Total Views */}
        <div className="bg-surface border border-border rounded-2xl p-5 flex items-center gap-4 hover:border-brand-purple/20 transition-colors">
          <div className="p-3.5 bg-brand-purple/10 text-brand-purple rounded-xl">
            <Eye size={20} />
          </div>
          <div>
            <span className="text-xs text-text-muted font-semibold block">Нийт хандалт (Views)</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              <span className="text-2xl font-black text-text-main font-mono">31,520</span>
        ...
        <div className="bg-surface border border-border rounded-2xl p-5 flex items-center gap-4 hover:border-brand-purple/20 transition-colors">
          ...
          <div>
            <span className="text-xs text-text-muted font-semibold block">Уншигчид (Visitors)</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              <span className="text-2xl font-black text-text-main font-mono">11,260</span>
        ...
        <div className="bg-surface border border-border rounded-2xl p-5 flex items-center gap-4 hover:border-brand-purple/20 transition-colors">
          ...
          <div>
            <span className="text-xs text-text-muted font-semibold block">Унших дундаж хугацаа</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              <span className="text-2xl font-black text-text-main font-mono">4м 12с</span>
        ...
        <div className="bg-surface border border-border rounded-2xl p-5 flex items-center gap-4 hover:border-brand-purple/20 transition-colors">
          ...
          <div>
            <span className="text-xs text-text-muted font-semibold block">Идэвхтэй сэтгэгдэл</span>
            <div className="flex items-baseline gap-2 mt-0.5">
              <span className="text-2xl font-black text-text-main font-mono">312</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#131B2E]/30 border border-border rounded-2xl p-5 space-y-4">
          <div className="flex items-center justify-between pb-2">
            <h3 className="text-text-main font-bold text-sm">Хандалтын өсөлтийн график (Уншигчид vs Нийт үзэлт)</h3>
          </div>
          <div className="h-72">
        ...
        <div className="bg-[#131B2E]/30 border border-border rounded-2xl p-5 flex flex-col justify-between">
          <h3 className="text-text-main font-bold text-sm border-b border-border pb-3">Урсгалын сувгууд (Traffic Channels)</h3>
          ...
          <div className="h-44 relative mt-2">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
              <span className="text-xl font-bold text-text-main">40%</span>
              <span className="text-[10px] text-text-muted">Шууд хандалт</span>
            </div>
          </div>
          ...
          <div className="space-y-2 mt-4">
            {TRAFFIC_SOURCES.map((src, idx) => (
              <div key={idx} className="flex items-center justify-between text-xs">
                ...
                <span className="text-text-main font-bold font-mono">{src.value}%</span>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#131B2E]/30 border border-border rounded-2xl p-5 space-y-4">
          <h3 className="text-text-main font-bold text-sm">Топ нийтлэлүүдийн үзүүлэлт (Views & Comments)</h3>
          <div className="h-64">
            <ResponsiveContainer width="100%" height="100%">
        ...
        <div className="bg-[#131B2E]/30 border border-border rounded-2xl p-5 flex flex-col justify-between">
          <h3 className="text-text-main font-bold text-sm border-b border-border pb-3">Төхөөрөмжүүдийн харьцаа</h3>
            ...
            {DEVICE_DATA.map((dev, idx) => (
              <div key={idx} className="space-y-1.5">
                <div className="flex items-center justify-between text-xs text-text-main">
                  ...
                  <span className="text-text-main font-bold font-mono">{dev.value}%</span>
                </div>
                {/* Bar */}
