  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-text-muted">Системийн үйл ажиллагааны түүх</p>
      </div>

      <div className="bg-surface shadow-[var(--shadow-card)] rounded-xl border border-border overflow-hidden">
        <div className="p-4 border-b border-border bg-[#0F172A]/50">
        ...
        <div className="divide-y divide-border">
           {logs.map((log) => (
              <div key={log.id} className="p-4 flex items-center gap-4 hover:bg-surfaceHighlight transition-colors font-mono text-sm">
