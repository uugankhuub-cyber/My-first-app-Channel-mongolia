...
export const MOCK_CONTENT: ContentItem[] = [
  {
    ...
    readTimeValue: 5,
    isVideo: true,
    videoUrl: 'https://www.youtube.com/watch?v=uD4izuPDy_A',
  ...
  },
  {
    ...
    readTimeValue: 8,
    isVideo: true,
    videoUrl: 'https://www.youtube.com/watch?v=5dZ_lvDgevk',
  ...
  },
  {
    ...
    readTimeValue: 10,
    isVideo: true,
    videoUrl: 'https://www.youtube.com/watch?v=U36F_k_r7Yg',
  ...
  },
  {
    ...
    readTimeValue: 3,
    isVideo: true,
    videoUrl: 'https://www.youtube.com/watch?v=9g0HIsP04u4',
    tags: ['Байгаль', 'Амьтад'],
